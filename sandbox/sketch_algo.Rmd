---
title: "The 1-TMLE algorithm for an additive treatment shift parameter"
...
```{r test_est_Hn}
test_est_h <- est_Hn(gn = test_est_g)
head(test_est_h)
```
...
```{r tmle_shifttx}
tmle_shifttx <- function(fluc_fit_out, Hn, Y, tol_eif = 1e-7) {
    # compute the 1-TMLE
