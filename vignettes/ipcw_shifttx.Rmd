...
library(condensier)
library(shifttx)
tmle_glm_shift1 <- tmle_shifttx(W = W, A = A, Y = Y,
                                C = C, V = list(W = W, Y = Y),
                                delta = 0.5,
                                fluc_method = "standard",
                                mod_args = list(
                                  ipcw_fit = list(fit_type = "glm",
                                    glm_formula = "Delta ~ ."),
                                  g_fit = list(fit_type = "glm",
                                    nbins = 35, bin_method = "dhist",
...
```{r}
tmle_glm_shift2 <- tmle_shifttx(W = W, A = A, Y = Y,
                                C = C, V = list(W = W, Y = Y),
                                delta = 0.5,
...
```{r}
tmle_sl_shift1 <- tmle_shifttx(W = W, A = A, Y = Y,
                               C = C, V = list(W = W, Y = Y),
                               delta = 0.5,
                               fluc_method = "standard",
                               mod_args = list(
                                 ipcw_fit = list(fit_type = "sl",
                                   sl_lrnrs = sl_lrn),
...
```{r}
tmle_sl_shift2 <- tmle_shifttx(W = W, A = A, Y = Y,
                               C = C, V = list(W = W, Y = Y),
                               delta = 0.5,
                               fluc_method = "weighted",
                               mod_args = list(
