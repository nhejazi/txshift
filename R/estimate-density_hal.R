...
#'  the data in long format, as discussed in \insertRef{diaz2011super}{txshift},
...
predict.haldensify <- function(object, ..., new_A, new_W) {
  ...
  hazard_pred <- predict(object$hal_fit, new_data = long_data)
...
#'  \insertRef{diaz2011super}{txshift}.
#'
#' @importFrom assertthat assert_that
#
